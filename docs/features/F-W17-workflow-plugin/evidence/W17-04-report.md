...
`docs/plans/wave16-progress.md:113` (matched only by the looser `/home/` substring rule; the text is
"workspace/home/target"). The same loose rule also matches the pre-existing `bridge-upgrade`

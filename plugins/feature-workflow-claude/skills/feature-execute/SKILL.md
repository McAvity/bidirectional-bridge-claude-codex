...
> **Instruction source — check first.** This is `feature-workflow:feature-execute` from the `feature-workflow`
...
>   `<instructions.workflow_skills>/feature-execute/SKILL.md`, the guide `instructions.guide` and
...
`python3 ${CLAUDE_PLUGIN_ROOT}/skills/feature-exchange/scripts/feature_exchange.py export --feature <feature>

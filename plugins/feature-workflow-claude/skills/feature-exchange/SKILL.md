...
> **Instruction source — check first.** This is `feature-workflow:feature-exchange` from the `feature-workflow`
...
>   `<instructions.workflow_skills>/feature-exchange/SKILL.md`, the guide `instructions.guide` and
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/feature-exchange/scripts/feature_exchange.py export \
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/feature-exchange/scripts/feature_exchange.py verify \
  --archive "$(python3 ${CLAUDE_PLUGIN_ROOT}/skills/feature-exchange/scripts/feature_exchange.py namespace \
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/feature-exchange/scripts/feature_exchange.py inspect-return \

...
> **Instruction source — check first.** This is `feature-workflow:feature-plan` from the `feature-workflow`
...
>   `<instructions.workflow_skills>/feature-plan/SKILL.md`, the guide `instructions.guide` and

...
```bash
python3 <package>/skills/feature-exchange/scripts/feature_exchange.py export \
...
```bash
python3 <package>/skills/feature-exchange/scripts/feature_exchange.py verify \
  --archive "$(python3 <package>/skills/feature-exchange/scripts/feature_exchange.py namespace \
...
```bash
python3 <package>/skills/feature-exchange/scripts/feature_exchange.py inspect-return \

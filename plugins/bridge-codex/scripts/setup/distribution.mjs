...
//     salted-free SHA-256, which is enough to compare two reports and useless for reconstructing
...
export function distributionMetadata({
  ...
  const generated = executorPackagePresent ? readJson(join(executorPackage, "GENERATED.json")) : null;
